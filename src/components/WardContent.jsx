...
const wardContent = (selectedWard, selectWard) => {
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
          <br />
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">305.65</span> incidents,
            but only had <span className="font-bold text-[#00434d]">136</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">327.75</span> incidents,
            but only had <span className="font-bold text-[#00434d]">216</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">534.75</span> incidents,
            but only had <span className="font-bold text-[#00434d]">457</span>.
          </p>
          <br />
          <p>
            {" "}
    ...
    "Kanata North": (
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            The crime committed more often relative to the rest of the city is{" "}
            <span className="highlight">Mischief</span>. The ward was expected
            to have <span className="highlight">64.61</span> number of
            incidents, but actually had <span className="highlight">86</span>.
            The crime occurring less often than projected is{" "}
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">322.36</span> incidents,
            but only had <span className="font-bold text-[#00434d]">292</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">93.80</span> incidents,
            but only had <span className="font-bold text-[#00434d]">40</span>.
          </p>
          <br />
          <p>
            {" "}
            ...
            in crime rate from 2021 to 2022. Violent crime is down{" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            The crime committed more often relative to the rest of the city is{" "}
            <span className="highlight">Mischief</span>. The ward was expected
            to have <span className="highlight">61.80</span> number of
            incidents, but actually had <span className="highlight">122</span>.
            The crime occurring less often than projected is{" "}
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">308.34</span> incidents,
            but only had <span className="font-bold text-[#00434d]">191</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">1.11 times</span> more dangerous than
            the average ward with <span className="highlight">3264</span> crimes
            per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
          <br />
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">1.02 times</span> more dangerous than
            the average ward with <span className="highlight">3679</span> crimes
            per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">611.83</span> incidents,
            but only had <span className="font-bold text-[#00434d]">589</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">682.99</span> incidents,
            but only had <span className="font-bold text-[#00434d]">520</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">1.78 times</span> more dangerous than
            the average ward with <span className="highlight">6039</span> crimes
            per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">3.07 times</span> more dangerous than
            the average ward with <span className="highlight">11156</span>{" "}
            crimes per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
          <br />
          <p>
            ...
            <span className="highlight">Theft of Motor Vehicle</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">391.39</span> incidents,
            but only had <span className="font-bold text-[#00434d]">111</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">1.56 times</span> more dangerous than
            the average ward with <span className="highlight">5733</span> crimes
            per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
          ...
          <p>
            The crime committed more often relative to the rest of the city is{" "}
            <span className="highlight">Assaults</span>. The ward was expected
            to have <span className="highlight">207.10</span> number of
            incidents, but actually had{" "}
            <span className="font-bold text-[#00434d]">257</span>. The crime
            occurring less often than projected is{" "}
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">955.21</span> incidents,
            but only had <span className="font-bold text-[#00434d]">920</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">3.53 times</span> more dangerous than
            the average ward with <span className="highlight">12537</span>{" "}
            crimes per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
          ...
          <p>
            ...
            <span className="highlight">Theft of Motor Vehicle</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">217.82</span> incidents,
            but only had <span className="font-bold text-[#00434d]">60</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">1.21 times</span> more dangerous than
            the average ward with <span className="highlight">4401</span> crimes
            per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            The crime committed more often relative to the rest of the city is{" "}
            <span className="highlight">Assaults</span>. The ward was expected
            to have <span className="highlight">142.70</span> number of
            incidents, but actually had{" "}
            <span className="font-bold text-[#00434d]">184</span>. The crime
            occurring less often than projected is{" "}
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">658.19</span> incidents,
            but only had <span className="font-bold text-[#00434d]">541</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">1.32 times</span> more dangerous than
            the average ward with <span className="highlight">4513</span> crimes
            per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            <span className="highlight">1.37 times</span> more dangerous than
            the average ward with <span className="highlight">4884</span> crimes
            per 100,000 residents. The average ward has{" "}
            <span className="highlight">3619</span> crimes per 100,000
            residents.
          </p>
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">209.15</span> incidents,
            but only had <span className="font-bold text-[#00434d]">116</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">168.19</span> incidents,
            but only had <span className="font-bold text-[#00434d]">100</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">275.46</span> incidents,
            but only had <span className="font-bold text-[#00434d]">197</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            The crime committed more often relative to the rest of the city is{" "}
            <span className="highlight">Mischief</span>. The ward was expected
            to have <span className="highlight">69.69</span> number of
            incidents, but actually had <span className="highlight">91</span>.
            The crime occurring less often than projected is{" "}
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">347.69</span> incidents,
            but only had <span className="font-bold text-[#00434d]">299</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          ...
          <p>
            ...
            <span className="highlight">Theft $5000 and Under</span>. The ward
            was expecting{" "}
            <span className="font-bold text-[#00434d]">297.56</span> incidents,
            but only had <span className="font-bold text-[#00434d]">143</span>.
          </p>
          <br />
          <p>
            {" "}
      ...
      <div>
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            well-being of its diverse communities. This project aims to
            visualize the data that the city has released from 2005 to 2022 to
            illustrate how the safety of Ottawa has evolved, both within
        ...
        <div className="text-[#052E41] text-sm font-light">
          <p>
            <br />
            Socio-economic Status (SES) in Ottawa is determined by the Ottawa
            Neighbourhood Study considering factors like income, employment, and
            education. The least advantaged 20% of neighborhoods have over three
            times the crime rate compared to the most advantaged. However, the
            lowest crime rates are found not in the SES 1 neighborhoods but in
            the second SES quintile.
          </p>
        </div>
        <br />
        <h3 className="text-lg font-medium text-[#052E41]  ">
        ...
        <div className="text-[#052E41] text-sm font-light">
          <p>
            ...
            standard levels. This trend is reflected across other Canadian
            cities. Ottawa consistently ranks as one of the safest major
            metropolitan areas in Canada, finishing 2022 with a similar crime
            severity index to 2015.
          </p>
        </div>
        <br />
        <h3 className="text-lg font-medium text-[#052E41]  ">
  ...
  return wards[selectedWard] || <div>Ward not found</div>;
};

const WardContent = ({ selectedWard, selectWard }) => {
  return <div>{wardContent(selectedWard, selectWard)}</div>;
};
